...
INSERT INTO faculty_users (login_id, password_hash, security_code, full_name, department, email) 
VALUES 
    ('VIT0021', '$2a$10$example_hash_here', 'SEC123', 'Dr. John Smith', 'Computer Science', 'john.smith@vit.edu'),
    ('VIT0022', '$2a$10$example_hash_here', 'SEC124', 'Dr. Jane Doe', 'Electronics', 'jane.doe@vit.edu')
ON CONFLICT (login_id) DO NOTHING;

INSERT INTO admin_users (admin_id, password_hash, security_code, full_name, email) 
VALUES 
    ('ADMIN001', '$2a$10$example_hash_here', 'ADMIN123', 'Admin User', 'admin@vit.edu')
